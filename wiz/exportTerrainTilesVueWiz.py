...
polySqrt = math.sqrt(polyCount / 3)
estPad = ts / polySqrt
...
print("Estimated Padding: " + str(estPad) + "\n")
...
for z in range(0, divBy):
	for x in range(0, divBy):
		...
		Refresh()
		time.sleep(0)	
		WaitForOpenGLProceduralTerrainPreviews() 

		didExport = ExportObject(fileName, true, "","","","")
